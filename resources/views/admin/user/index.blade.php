 ...
 <div class="content-header">
  ...
  <section class="content">
    ...
    <tr>
      ...
      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Уровень</th>
      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Баллы</th>
    </thead>
    <tbody>
    ...
    <tr>
      ...
      <th rowspan="1" colspan="1">Уровень</th>
      <th rowspan="1" colspan="1">Баллы</th>
    </tr>
    </tfoot>
