            ...
            <div class="card-body box-profile">
              ...
              <ul class="list-group list-group-unbordered mb-3">
                <li class="list-group-item">
                  <b>Уровень</b> <a class="float-right">{{ $user->level }}</a>
                </li>
                <li class="list-group-item">
                  <b>Баллы</b> <a class="float-right">{{ $user->points }}</a>
                </li>
                <li class="list-group-item">
                  <b>Правильные ответы</b> <a class="float-right">100</a>
                </li>
              </ul>
          ...
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#points" data-toggle="tab">Баллы</a></li>
              </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane" id="settings">
                  <form class="form-horizontal">
                    ...
                    <div class="form-group row">
                      <label for="inputExperience" class="col-sm-2 col-form-label">Описание</label>
                      <div class="col-sm-10">
                        <textarea class="form-control" id="inputExperience" placeholder="{{ $user->description }}" ></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputSkills" class="col-sm-2 col-form-label">Дата рождения</label>
                      <div class="col-sm-10">
                        <input type="date" class="form-control" id="inputSkills" value="{{ $user->birthdate ? $user->birthdate : '01.01.2000' }}">
                      </div>
                    </div>
                    <div class="form-group row">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
              ...
              <div class="mr-3">
                ...
                <form action="{{route('admin.user.destroy', $user->id)}}" method="post">
                 ...
                 <div class="btn-group ml-3">
                  <button type="button" class="btn btn-success">Просмотреть сводку</button>
                  <button type="button" class="btn btn-success dropdown-toggle dropdown-icon" data-toggle="dropdown" aria-expanded="false">
                    <span class="sr-only">Toggle Dropdown</span>
                  </button>
                  <div class="dropdown-menu" role="menu" style="">
                    <a class="dropdown-item" href="#">Опыта</a>
                    <a class="dropdown-item" href="#">Баллов</a>
                    <a class="dropdown-item" href="#">Ответов</a>
            ...
            <tr>
              <td>Уровень опыта</td>
              <td>{{$user->level}} ({{$user->experience}} exp)</td>
            </tr>
            ...
            <tr>
              <td>Связан с Google ID</td>
              <td>
                  @if ($user->google_id)
                      <a href="{{ route('admin.user.unlinkGoogle', $user->id) }}">Отвязать</a>
                  @else
                      Нет
                  @endif
              </td>
